...
```bash
git clone https://github.com/aalencarvz1/base-server-sso-client-security-config.git
cd base-server-sso-client-security-config
mvn install
```
...
> 🔗 Published on [Maven Central (Sonatype)](https://central.sonatype.com/artifact/io.github.aalencarvz1.libs.security.sso/base-server-sso-client-security-config)