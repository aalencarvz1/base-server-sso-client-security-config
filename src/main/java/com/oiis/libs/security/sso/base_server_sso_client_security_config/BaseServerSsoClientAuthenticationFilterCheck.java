 ...
 */
@Component
public class BaseServerSsoClientAuthenticationFilterCheck extends OncePerRequestFilter {

    private static final Logger logger = LoggerFactory.getLogger(BaseServerSsoClientAuthenticationFilterCheck.class);
     ...
     */
    public BaseServerSsoClientAuthenticationFilterCheck(String baseSsoEndpoint) {
