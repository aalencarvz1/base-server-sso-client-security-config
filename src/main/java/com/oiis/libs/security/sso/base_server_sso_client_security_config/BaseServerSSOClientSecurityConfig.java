package com.oiis.libs.security.sso.base_server_sso_client_security_config;
...
@Configuration
@EnableWebSecurity
public class BaseServerSSOClientSecurityConfig {

    private static final Logger logger = LoggerFactory.getLogger(BaseServerSSOClientSecurityConfig.class);
     ...
     */
    @Bean
    public BaseServerSsoClientAuthenticationFilterCheck baseSsoAuthenticationFilterCheck(@Value("${sso.base-endpoint}") String baseSsoEndpoint) {
        return new BaseServerSsoClientAuthenticationFilterCheck(baseSsoEndpoint);
    }
     ...
     */
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http, BaseServerSsoClientAuthenticationFilterCheck baseSsoAuthenticationFilterCheck) throws Exception {
